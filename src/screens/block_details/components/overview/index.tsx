  ...
  return (
    <BoxDetails
      ...
      details={[
        ...
        {
          label: t('parentSlot'),
          detail: numeral(props.parentSlot).format('0,0'),
        },
        {
          label: t('parentHash'),
          detail: props.parentHash,
        },
        {
          label: t('processedTx'),
          detail: numeral(props.processedTx).format('0,0'),
        },
        {
          label: t('successfulTx'),
          detail: numeral(props.successfulTx).format('0,0'),
        },
      ]}
    />
  );
